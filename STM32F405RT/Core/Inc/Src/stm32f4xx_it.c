...
//GPS_UBX protocol variable of [massage data array is 36 byte], [massage complete receive]
...
void UART4_IRQHandler(void)
{
  /* USER CODE BEGIN UART4_IRQn 0 */
	//GPS module UART4==> this is GPS to FC UART TX and RX
	...
	if(LL_USART_IsActiveFlag_RXNE(UART4))
		{
			...
			//UBX protocol massage data rx and tx
			switch(cnt)
			{
			case 0:
...
void UART5_IRQHandler(void)
{
  /* USER CODE BEGIN UART5_IRQn 0 */
	...
	if(LL_USART_IsActiveFlag_RXNE(UART5))
	{
		...
		// Send uart5 data to usart6 buffer
